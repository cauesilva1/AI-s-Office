...
export function buildRouterPrompt(
  ...
  return [
    ...
    "",
    "Guia de intenção:",
    "- design: UI/UX, identidade visual, brief de arte, publicidade visual, anúncio, peça gráfica,",
    "  personagem/mascote com produto, pedidos de IMAGEM, FOTO, ILUSTRAÇÃO, VÍDEO, ÁUDIO, mockup",
    "- engineering: código, bugs, APIs, arquitetura, refatoração",
    "- research: pesquisa, comparar opções, benchmark, análise (sem pedir arte/visual)",
    "- data: métricas, SQL, dashboards, ETL, KPIs",
    "- devops: deploy, infra, Docker, CI/CD, observabilidade",
    "- growth: copy de marketing, funil, SEO, estratégia de campanha (texto) — se o pedido for",
    "  CRIAR A PEÇA VISUAL/ARTE do anúncio, prefira design",
    "",
    "Exemplos:",
    '- "crie um design de publicidade da Fanta com Homem-Aranha" → {"sectorId":"design","pipeline":["design"],"confidence":0.95,"reason":"peça visual de anúncio"}',
    '- "refatore o endpoint de auth" → {"sectorId":"engineering","pipeline":["research","engineering"],"confidence":0.9,"reason":"código"}',
    '- "compare bancos vetoriais" → {"sectorId":"research","pipeline":["research"],"confidence":0.88,"reason":"pesquisa"}',
    "",
    ...
    "- Para gerar imagem/arte/vídeo/áudio/peça publicitária visual: pipeline [\"design\"] (só Design)",
    "- Para código: ex. [\"research\",\"engineering\",\"devops\"]",
    "- Nunca use research→engineering como fallback genérico para pedidos criativos/visuais",
    "",
